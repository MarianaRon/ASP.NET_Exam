...
namespace ASP.NET_Exam.Migrations
{
    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ApplicationUserSpecifications",
                columns: table => new
                {
                    Id = table.Column<string>(type: "TEXT", nullable: false),
                    UserId = table.Column<string>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUserSpecifications", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ApplicationUserSpecifications_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUserSchedules", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ApplicationUserSchedules_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApplicationUserSchedules_Schedules_ScheduleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUserSchedules_ScheduleId",
                table: "ApplicationUserSchedules",
                column: "ScheduleId");

            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUserSchedules_UserId",
                table: "ApplicationUserSchedules",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUserSpecifications_SpecializationId",
                table: "ApplicationUserSpecifications",
                column: "SpecializationId");

            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUserSpecifications_UserId",
                table: "ApplicationUserSpecifications",
                column: "UserId");
